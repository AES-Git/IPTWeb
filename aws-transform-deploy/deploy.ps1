...
param(
    ...
    # Shared parameters
    [string]$ApplicationName = 'InvestmentPortfolioTracker.Web',
    ...
    [string]$S3Bucket,
    [string]$S3Folder,
    [string]$MainBinary = 'InvestmentPortfolioTracker.Web',

    # ECS-specific parameters
    [string]$StackName = "AWSTransform-Deploy-App-Stack-InvestmentPortfolioTracker-Web-49505457",
